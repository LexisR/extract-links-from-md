...
//es un string y debemos hacer una funcion que reciba como parametro un string y no un markdown.
module.exports = {
  extractLinksFromMd(paragraph) {
    ...
    // puedo entrar al prompt de node solo tipeando: node y alli puedo escribir codigo node normal
